...
print('The fit parameters for inverse logarithm are (i_inf, del_i, tau, gamma):')
print(*popt)
...
plt.legend()
plt.title('Filename: ' + filename_freq +'\n'+r' $ i_{inf} - \Delta i/(1+(t/ \tau )^ \gamma) $' +'\n'+ r' $ = %5.2e - %5.2e /(1+(t/ %5.2e )^{%5.2e}) $'%(popt[0],popt[1],popt[2],popt[3]), fontsize = 16 )
plt.tight_layout()
